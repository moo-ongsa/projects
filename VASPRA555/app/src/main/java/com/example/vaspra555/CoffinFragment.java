 ...
 */
public class CoffinFragment extends Fragment {
    ImageButton btn_back;
    Button btn_submit;
    TextView txt_coffinvatname,txt_coffinvatdetail,txt_coffincurrentmoney,txt_coffinmaxmoney,txt_contructName;
    ...
    private String url = Server.URL + "vaspraPHP/coffin.php";
    public static CoffinFragment newInstance() {
        return  new CoffinFragment();}
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState){
        ...
        txt_coffinvatname = (TextView) view.findViewById(R.id.txt_CoffinVatName) ;
        txt_coffinvatdetail= (TextView) view.findViewById(R.id.txt_CoffinVatDetail);
        txt_coffincurrentmoney= (TextView) view.findViewById(R.id.txt_currentcoffinmoney);
        txt_coffinmaxmoney= (TextView) view.findViewById(R.id.txt_maxcoffinmoney);
        btn_back = (ImageButton) view.findViewById(R.id.btn_back_coffin);
        btn_submit = (Button) view.findViewById(R.id.btn_donatesubmitcoffin);
        ...
        final StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    txt_coffincurrentmoney.setText(currentDonation);
                    txt_coffinmaxmoney.setText(maxDonation);
                    txt_coffinvatdetail.setText(vatAddress);
                    txt_coffinvatname.setText(vatName);
