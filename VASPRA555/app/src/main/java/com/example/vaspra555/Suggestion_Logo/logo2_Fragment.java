 ...
 */
public class logo2_Fragment extends Fragment {

    public static logo2_Fragment newInstance() {
        return new logo2_Fragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate (R.layout.fragment_logo2_, container, false);
    }
    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState){
        super.onViewCreated(view, savedInstanceState);
        btn1 = (Button)view.findViewById (R.id.btn_smile1_logo2);
        btn1.setOnClickListener(OnClickGoto1);
        btn3 = (Button)view.findViewById (R.id.btn_smile3_logo2);
        btn3.setOnClickListener(OnClickGoto3);
        btn4 = (Button)view.findViewById (R.id.btn_smile4_logo2);
        btn4.setOnClickListener(OnClickGoto4);
        btn5 = (Button)view.findViewById (R.id.btn_smile5_logo2);
